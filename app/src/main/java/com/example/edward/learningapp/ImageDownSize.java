...
public class ImageDownSize {
    ...
    public void setScaledImage(ImageView imageView, final int resId) {
    ...
    public Bitmap readFromExternalStorage(String image){
        String photoPath = Environment.getExternalStorageDirectory()+"/" + image;
